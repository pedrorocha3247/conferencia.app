...
def processar_comparativo(texto_anterior, texto_atual, modo_separacao, emp_fixo_boleto):
    # <<NOVA ALTERAÇÃO INÍCIO>>: Lógica movida para calcular totais antes de filtrar
    ...
    # <<NOVA ALTERAÇÃO>>: Junta os totais calculados aos clientes removidos
...
def upload_file():
    ...
    try:
        ...
        # <<NOVA ALTERAÇÃO>>: Filtra os dados aqui para o relatório de validação simples
